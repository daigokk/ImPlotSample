...
大量生産・消費を前提とする経済活動でが多数の製品に対して複数の計測が行われています。このような製品の品質を担保する計測は日に日に高度化(正確さ、速さの向上)が求められています。

これらのアプリケーションでは自動計測が前提であり、自動計測の分野ではNI LabVIEWというソフトウェアが高いシェアを持っています。
